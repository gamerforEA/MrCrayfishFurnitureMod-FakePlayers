...
public class InventoryEnvelope extends InventoryBasic
{
	...
	protected static ItemStack envelopeStatic;
	...
	public static boolean isSigned()
	{
		...
		if (envelope.getItem() == MrCrayfishFurnitureMod.itemEnvelopeSigned)
			isValid = true;
		return isValid; */
		return envelopeStatic != null && envelopeStatic.getItem() == MrCrayfishFurnitureMod.itemEnvelopeSigned;
		// TODO gamerforEA code end
	}
	...
	{
		return NBTHelper.hasTag(this.envelope, "Envelope");
	}
	...
	protected void setNBT()
	{
		for (ItemStack itemStack : this.playerEntity.inventory.mainInventory)
		{
			if (itemStack != null && itemStack.getItem() instanceof IMail)
			{
				...
				if (nbt != null && nbt.getCompoundTag("Envelope").getString("UniqueID").equals(this.uniqueID))
				{
					itemStack.setTagCompound(this.envelope.getTagCompound());
					break;
				}
			}
		}
	...
	{
		return NBTHelper.getString(this.envelope, "Author");
	}

	protected void readFromNBT()
	{
		this.reading = true;
		NBTTagCompound nbt = NBTHelper.getCompoundTag(this.envelope, "Envelope");
		...
		NBTTagList itemList = (NBTTagList) NBTHelper.getCompoundTag(this.envelope, "Envelope").getTag("Items");
	...
	protected void writeToNBT()
	{
		...
		NBTHelper.setCompoundTag(this.envelope, "Envelope", inventory);
	}
	...
	public void writeToNBT(NBTTagCompound nbt)
	{
		...
		nbt.setTag("Envelope", inventoryNbt);
	}
	// TODO gamerforEA code end
}
